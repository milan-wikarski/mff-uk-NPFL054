...
# Text Mining library
# help https://cran.r-project.org/web/packages/tm/tm.pdf
library(tm)
...
# colors are assigned to the lables sorted alphabetically ARA, DEU, SPA, TEL, ZHO
...
#	legend = c("Spanish", "Chinese", "German", "Arabic", "Telugu"),
	legend = c("Arabic", "German", "Spanish", "Telugu", "Chinese"),
